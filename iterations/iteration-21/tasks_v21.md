...
| ID | Task | Status | Owner | Files | Dependencies |
|----|------|--------|-------|-------|--------------|
| P0-025-01 | Create `crates/agent/src/events.rs` with AgentEvent enum | TODO | | NEW (agent crate) | None |
| P0-025-02 | Implement `AgentEventEmitter` trait for AgentExecutor | TODO | | agent/src/executor.rs | P0-025-01 |
| P0-025-03 | Create `server/src/routes/ws/session_hub.rs` for event broadcast | TODO | | NEW | None |
...
| P0-025-14 | Verify build: `cargo build -p opencode-server` | TODO | | | P0-025-13 |
...
| P1-026-10 | Add test: GET /api/status returns 200 | TODO | | status_endpoint_tests.rs | P1-026-09 |
| P1-026-11 | Add test: response contains all required fields | TODO | | status_endpoint_tests.rs | P1-026-10 |
| P1-026-12 | Add test: endpoint accessible without auth | TODO | | status_endpoint_tests.rs | P1-026-11 |
| P1-026-13 | Verify build and tests pass | TODO | | | P1-026-12 |
