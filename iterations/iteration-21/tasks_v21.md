...
| P1-027-06 | Create test file `tests/src/streaming_response_tests.rs` | ✅ Done | | NEW | P1-027-05 |
| P1-027-07 | Add test: SSE streaming with curl equivalent | ✅ Done | | streaming_response_tests.rs | P1-027-06 |
| P1-027-08 | Add test: tokens arrive progressively | ✅ Done | | streaming_response_tests.rs | P1-027-07 |
...
| P1-028-09 | Add test: decision logged to audit trail | ✅ Done | | permission_integration_tests.rs | P1-028-08 |
| P1-028-10 | Verify permission build and tests pass | ✅ Done | | | P1-028-09 |
...
| P2-023-07 | Add tests for each component | ✅ Done | | ratatui-testing/tests/ | P2-023-06 |
...
| ID | Task | Status | Owner | Files | Dependencies |
|----|------|--------|-------|-------|--------------|
| P2-029-01 | Add deterministic hook test in `crates/plugin/src/lib.rs` | ✅ Done | | plugin/src/lib.rs | None |
| P2-029-02 | Test 100 iterations for consistent ordering | ✅ Done | | plugin/src/lib.rs | P2-029-01 |
| P2-029-03 | Document expected ordering behavior in test | ✅ Done | | plugin/src/lib.rs | P2-029-02 |
| P2-029-04 | Verify test passes: `cargo test -p opencode-plugin hook_determinism` | ✅ Done | | | P2-029-03 |
