...
| T-021 | Increase llm crate coverage | 80% | +25% | 2 days | ✅ Done |
| T-022 | Add cargo-llvm-cov CI gate | 80% threshold | - | 4 hours | ✅ Done |
...
| T-033 | Add SAFETY comments to unsafe blocks | `crates/plugin/src/lib.rs:661` | 30 min | ✅ Done |
| T-034 | Add SAFETY comments to unsafe blocks | `crates/tui/src/app.rs:4677,4690` | 30 min | ✅ Done |
