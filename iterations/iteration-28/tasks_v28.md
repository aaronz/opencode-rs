...
| T-002 | Fix `unwrap()` on Option - API key | `crates/tools/src/web_search.rs` | 70 | 30 min | Not Started |
...
|---------|-------------|------|-----------|--------|
| T-004 | Convert String errors to thiserror enums | `crates/server/src/routes/*.rs` | 8 hours | Not Started |
...
| Task ID | Description | File | Estimated | Status |
|---------|-------------|------|-----------|--------|
| T-006 | Fix tool registry read tool test | `tests/src/agent_tool_tests.rs` | 1 hour | Failing |
...
|---------|-------------|--------|-------|-----------|--------|
| T-017 | Increase core crate coverage | 80% | +20% | 2 days | Not Started |
