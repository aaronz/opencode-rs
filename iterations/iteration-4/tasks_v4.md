...
| P1-5 | Permission inheritance (parent→subagent) | agent | FR-005 | Phase 2 | ✅ Done | P0-2 |
...
| P1-11 | Streaming endpoints | server | FR-004 | Phase 1 | ✅ Done | P0-15 |
...
| P1-28 | Local model providers | llm | FR-012 | Phase 3 | Done | P1-25 |
...
| P2-2 | Workspace path validation | core | FR-001 | Phase 1 | Done | None |
...
| P2-4 | Result caching for safe tools | tools | FR-006 | Phase 3 | Done | P0-4 |
...
| P2-13 | Home view | tui | FR-018 | Phase 2 | Done | None |
...
| T-019-4 | Session/message lifecycle tests | server | FR-019 | Phase 5 | ✅ Done | P0-15 |
...
| T-021-4 | Skills discovery tests | core | FR-021 | Phase 5 | Done | P1-29 |
...
| T-023-2 | Skill path regression suite | core | FR-023 | Phase 5 | Done | P1-29 |
| T-023-3 | Plugin ownership boundary suite | plugin | FR-023 | Phase 5 | Done | P0-18 |
...
| T-024-2 | Security tests | all | FR-024 | Phase 6 | ✅ Done | Phase 5 |
| T-024-3 | Recovery tests | storage | FR-024 | Phase 6 | ✅ Done | T-019-4 |
