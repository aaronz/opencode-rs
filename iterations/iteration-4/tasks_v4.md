...
| P0-12 | Config ownership boundary (opencode.json vs tui.json) | config | FR-003 | Sprint 0 | Pending | None |
| P0-13 | Route registration by resource group | server | FR-004 | Sprint 1 | Pending | None |
...
| Task ID | Title | Module | FR | Sprint | Status | Dependencies |
|---------|-------|--------|-----|--------|--------|--------------|
| P0-1 | Exactly one active primary agent invariant | agent | FR-005 | Sprint 2 | Pending | None |
