# OpenCode Rust Port — Specification Document v6

**Version:** 6.0
**Generated:** 2026-04-12
**Based on:** PRD specifications and gap analysis (Iteration 6)
**Status:** Draft
...
- **Components:**
  ...
  - Plugin cleanup/unload ✅ (P2-10 - completed)
...
- **Components:**
  ...
  - **Slash commands ✅ (P1-4 - All implemented: `/compact`, `/connect`, `/help`)**
  - Input model ⚠️ (P1-5 - partial: multiline, Shift+Enter for new line)
...
- **P1 Gaps:**
  - Multiline input terminal support (P1-5 - deferred)
- **P2 Gaps:**
...
| **P2-15** | **Git test code bugs** | **git** | **n/a** | ❌ **NEW** |
...
- 8 duplicate test name definitions (likely two test modules with same names)
...
| Iteration 5 Spec | [spec_v5.md](./spec_v5.md) | Previous version |
| Iteration 4 Spec | [spec_v4.md](./spec_v4.md) | Earlier version |
...
|---------|------|---------|
| 6.0 | 2026-04-12 | Updated based on Iteration 6 gap analysis. Overall completion ~80-85%. P0-new-1 resolved (git syntax fixed), P0-new-3 implemented (ACP transport complete). P1-7, P1-8, P1-10, P1-11 completed. P2-10 completed. P2-15 introduced (git test bugs). P0-new-2 remains as sole P0 blocker. Phase 4 coverage improved to ~70%. Build status: git compiles but tests error. Added FR-026, FR-027, FR-028 for new PRDs. Updated agent table to reflect built-in agents with visibility. |
