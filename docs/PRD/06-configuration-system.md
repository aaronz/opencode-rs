...
| Subsystem | Document | Config Ownership |
|-----------|----------|------------------|
| Core Config | This document | Schema authority |
| Agent System | [02-agent-system.md](./02-agent-system.md) | Agent config structure, permission evaluation |
| Tools System | [03-tools-system.md](./03-tools-system.md) | Tool implementation, custom tools |
| LSP System | [05-lsp-system.md](./05-lsp-system.md) | LSP config schema |
| Plugin System | [08-plugin-system.md](./08-plugin-system.md) | Server/runtime plugin internals, hooks, events |
| TUI System | [09-tui-system.md](./09-tui-system.md) | `tui.json` schema, themes, keybinds |
| TUI Plugin API | [15-tui-plugin-api.md](./15-tui-plugin-api.md) | TUI plugin config, `plugin_enabled`, runtime enable/disable |
| Server API | [07-server-api.md](./07-server-api.md) | Server config, endpoint ownership |
| Skills System | [12-skills-system.md](./12-skills-system.md) | Skill loading, permission patterns |
